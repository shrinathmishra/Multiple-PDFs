...
//import com.example.demo2.demo2.Customer;
//import com.example.demo2.demo2.CustomerRepository;
//import com.example.demo2.demo2.CustomerService.MyTableClass;
//import com.example.demo2.demo2.CustomerService.MyTextClass;
...
public class CustomerService {
	...
	public void generateAllPdfs() throws IOException {
        List<Customer> customers = entityRepository.findAll();
	...
	private void generatePdfForCustomer(Customer customer) throws IOException {
		
		if (customer != null) {

			FileWriter writer = new FileWriter("C:\\ABHI\\createPDF\\result\\invoice\\apiTesting\\NewTimestampsfor100.txt", true);
			...
			PDImageXObject headImage = PDImageXObject.createFromFile(
					"C:\\ABHI\\createPDF\\PDFBoxTesting\\src\\main\\resources\\img\\IndianTadkaHead.png", document);
			...
			myTextClass.addMultiLineText(contactDetails, 18,
					(int) (pageWidth - font.getStringWidth("7574885947") / 1000 * 15 - 10), pageHeight - 25, font, 15,
					Color.BLACK);

			myTextClass.addSingleLineText("Indian Tadka", 25, pageHeight - 150, font, 40, Color.BLACK);

			// Use the retrieved name and mobile number in the PDF
			myTextClass.addSingleLineText("Customer Name: " + name, 25, pageHeight - 250, font, 16, Color.BLACK);
			myTextClass.addSingleLineText("Mo. No: " + mobileNumber, 25, pageHeight - 274, font, 16, Color.BLACK);

			// Existing PDF generation code...
			String invoiceNo = "Invoice# 2580";
			float textWidth = myTextClass.getTextWidth(invoiceNo, font, 16);
			myTextClass.addSingleLineText(invoiceNo, (int) (pageWidth - 25 - textWidth), pageHeight - 250, font, 16,
					Color.BLACK);
			...
			myTextClass.addSingleLineText("Date: " + d_format.format(new Date()),
					(int) (pageWidth - 25 - dataTextWidth), pageHeight - 274, font, 16, Color.BLACK);

			String time = t_format.format(new Date());
			float timeTextWidth = myTextClass.getTextWidth("Time: " + time, font, 16);
			myTextClass.addSingleLineText("Time: " + time, (int) (pageWidth - 25 - timeTextWidth), pageHeight - 298,
					font, 16, Color.BLACK);
...
//            Method of Payments
			String[] paymentMethod = { "Methods of Payment we accept: ", "Cash, PhonePe, GPay, RuPay",
...
//            authorized signatory
			...
			myTextClass.addSingleLineText(bottomLine, (int) (pageWidth - bottomLineWidth) / 2, 50, italicFont, 20,
					Color.DARK_GRAY);
			...
			document.save("C:\\ABHI\\createPDF\\result\\invoice\\apiTesting\\NewInvoice"+id+".pdf");
			document.close();
			Date endTime = new Date();

			long elapsedTime = endTime.getTime() - startTime.getTime();

			String log = id+ " Start Time: " + dateFormat.format(startTime) + "\n" +
